...
class PetStore3_1 implements SpecInterface
{
						...
						->setRequestBody(
							(new OA\Operations\RequestBody())
								->addMediaType(
									...
									(new OA\Operations\MediaType())
										->setSchema(
											(new OA\Schema\Schema())->setType("string")->setFormat("binary"),
										),
								),
						),
				),
	...
	/**
	 * Source: https://github.com/readmeio/oas/blob/v5.16.1/3.1/json/petstore.json
	 */
	public function assertFile(): string
	{
		return __DIR__ . '/examples/petstore.3.1.json';
	}
}
